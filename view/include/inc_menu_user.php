...
<li class="dropdown">
    ...
    <ul class="dropdown-menu">
        <li>
            <a href="http://localhost/setac/ctrl/cadastro.php?processo=dados&usu=<?php echo($usuId); ?>">Meus dados</a>
        </li>
        <li>
            <a href="http://localhost/setac/ctrl/pensandonum nome.php">Inscrições</a>
        </li>
        <li>
            <a href="http://localhost/setac/ctrl/administracao.php">Administração</a>
        </li>

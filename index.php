...
?>
	...
	<section class="container" id="conteudo">
		<div class="row">
			<div class="col-md-8">
				...
				<p class="text-justify">O evento busca oportunizar a vinda de palestrantes a fim de expor novas experiências, renovar conhecimentos e inter-relacionamento da comunidade acadêmica.</p>
			</div>
			<div class="col-md-4">
  				<div class="lateral-box">
					<h2 class="titulo-direita">Datas Importantes</h2>
					<ul class="datas-importantes">
						<li>Junho de 2017 <br> Inicio do prazo para submissão de trabalhos científicos</li>
						<li>Setembro de 2017 <br> Fim do prazo para submissão de trabalhos científicos</li>
						<li id="before-call">Outubro de 2017 <br> IVª Edição da SeTAC²</li>
					</ul>
				</div>
			</div>
		</div>
	...
	<section class="container" id="apoio-evento">
		<div class="row">
			<div class="col-md-12"><h2>Apoio</h2></div>			
		</div>
		<div class="row">
			<div class="col-md-2">
